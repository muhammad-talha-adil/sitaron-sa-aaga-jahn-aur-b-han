...
@section('page_title', 'Add Individual Student')
@section('content')
@if(session('success'))
...
<!--begin::Form-->
<form action="{{ url('students/create-individual') }}" class="form mb-15" method="post" id="add-student-form" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row g-3 mb-8">
        <div class="col-md-4 fv-row">
            ...
            <input type="text" class="form-control form-control-solid" placeholder="Enter School Name" name="school_name" id="school_name" />
        </div>
    ...
    <div class="row g-3 mb-8">
        <div class="col-md-4 fv-row">
            ...
            <input type="number" class="form-control form-control-solid" placeholder="Enter WhatsApp Number" name="contact" id="contact" />
        </div>
    </div>
