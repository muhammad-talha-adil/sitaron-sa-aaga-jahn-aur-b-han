...
$slips_per_page = 2;
$pages = ceil($total_records / $slips_per_page);
    ?>

    @for ($page = 0; $page < $pages; $page++)
        @php
            $start = $page * $slips_per_page;
            $end = min($start + $slips_per_page, $total_records);
        @endphp
                    ...
                    <div class="info-wrapper">
                        <div class="student-container">
                            <div class="student-info">
                                ...
                                {{-- <div class="row">
                                    <div class="label">Examination Center:  </div>
                                    <div class="value">
                                        The TIPS College, D-Ground Faisalabad
                                    </div>
                                </div> --}}
                            </div>
                        </div>
